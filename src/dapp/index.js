...
(async() => {
    ...
    let contract = new Contract('localhost', () => {
        ...
        DOM.elid('register-airline').addEventListener('click', async() => {
            ...
            // Write transaction
            contract.registerAirline(address, sender, (error, result) => {
        ...
        DOM.elid('fund').addEventListener('click', async() => {
            ...
            let address = DOM.elid('airline-address').value;
            // Write transaction
            contract.fund(address, funds, (error, result) => {
...
function addAirlineOption(hash) {
    var dropdown = DOM.elid("airlineDropdownOptions");

    let newOption = DOM.button({className: 'dropdown-item', value: hash, type:"button"}, hash);
